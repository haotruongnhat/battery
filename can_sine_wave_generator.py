...
# import pickle
# with open(r'modules\anomaly\dataset\sine_wave\labeled\train\sine_wave_8_signals.pkl', 'wb') as b:
#     pickle.dump(train_data.tolist(), b)

# with open(r'modules\anomaly\dataset\sine_wave\labeled\test\sine_wave_8_signals.pkl', 'wb') as b:
